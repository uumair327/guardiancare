...
class _QuizPageState extends State<QuizPage> {
  ...
  Future<void> fetchQuizes() async {
    ...
    setState(() {
      quizNames = names.toList();
      quizThumbnails = thumbnails.toList();
    });
  }
  ...
  Future<void> getQuestions() async {
    ...
    setState(() {
      questions = ques.cast<Map<String, dynamic>>();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    List<Quiz> quizzes = [
      Quiz(
        ...
        questions: questions
            .where((question) => question["quiz"] == "child abuse")
            .toList(),
        // questions: [
        //   {
      ...
      Quiz(
        ...
        questions: questions
            .where((question) => question["quiz"] == "sexual exploitation")
            .toList(),
        // questions: [
        //   {
      ...
      Quiz(
        ...
        questions: questions
            .where((question) => question["quiz"] == "cyberbullying")
            .toList(),
        // questions: [
        //   {
