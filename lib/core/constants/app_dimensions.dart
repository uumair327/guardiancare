...
class AppDimensions {
  ...
  static const double inputPaddingV = 16;
  ...
  static const borderRadiusTopM = BorderRadius.vertical(top: Radius.circular(radiusM));
  static const borderRadiusTopL = BorderRadius.vertical(top: Radius.circular(radiusL));
  
  /// Bottom-only radius presets
  static const borderRadiusBottomM = BorderRadius.vertical(bottom: Radius.circular(radiusM));
  static const borderRadiusBottomL = BorderRadius.vertical(bottom: Radius.circular(radiusL));
  ...
  static const double buttonMinWidthS = 88;
  ...
  static const double buttonMinWidthL = 160;
  ...
  static const double borderExtraThick = 3;
  ...
  /// Small logo - 80.0
  static const double logoS = 80;
  
  /// Medium logo - 120.0
  static const double logoM = 120;
  
  /// Large logo - 160.0
  static const double logoL = 160;
  ...
  static const double listItemHeightS = 56;
  
  /// List item height large
  static const double listItemHeightL = 88;
  ...
  static const double carouselAspectRatioSquare = 1;
  ...
  static const double carouselItemSpacing = 16;
  ...
  static const double circularButtonSize = 70;
  
  /// Circular button size (alias for consistency)
  static const double buttonCircularSize = 70;
  
  /// Circular button icon size
  static const double circularButtonIconSize = 32;

  // ==================== Shimmer ====================
  
  /// Shimmer height
  static const double shimmerHeight = 200;
  
  /// Shimmer border radius
  static const double shimmerRadius = 12;
  ...
  static const double maxContentWidthNarrow = 600;
